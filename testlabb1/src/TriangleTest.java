...
public class TriangleTest extends TestCase {
	...
	protected void setUp() {
		EC1 = new Triangle(1, 1, 1);//BVA/EP, valid
		EC2 = new Triangle(0, 0, 0);//BVAEP, inte valid
		...
		EC16 = new Triangle(5, 4, 5);//likbent EP
		EC19 = new Triangle(5, 4, 3);//rätvinkel, BVA
		EC40 = new Triangle(Integer.MAX_VALUE, Integer.MAX_VALUE,
				Integer.MAX_VALUE);//BVA stort.
		EC37 = new Triangle(1, 2, 3);//scalene BVA
		EC39 = new Triangle(3, 4, 5);//rätvinkel, BVA
		almostRightAngle = new Triangle(270, 110, 250);//BVA, nästan rät
		almostIsossceles = new Triangle(300, 301, 100);//BVA, nästan likbent
		almostEquilateral = new Triangle(300, 300, 301);//BVA, nästan liksidig, övre
		almostEquilateral2 = new Triangle(300, 300, 299);//BVA, nästan liksidig, undre
	}
	...
	public void testRightAngled2BVAEP() {
		assertTrue("Should return true for a right-angled triangle",
	...
	/**
	public void testIsImpossible6EP() {
...
*/
	...
	public void testGetSideLengthBVAEP() {
	...
	public void testGetPerimeter3BVA() {
	...
	public void testisIsoscelesBVAEP() {
	...
	public void testisEquilateral2BVAEP() {
